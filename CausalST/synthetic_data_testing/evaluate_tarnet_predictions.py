...
def evaluate_predictions(storage_dir, dataset_number):
    ...
    # Load TARNet predictions
    predictions_path = os.path.join(storage_dir, 'synthetic_datasets', 'CATE_testing',
                                  'tarnet_dataset_predictions', f'final_object_tarnet_predictions_{dataset_number}.h5ad')
    ...
    # Save plots
    plots_dir = os.path.join(storage_dir, 'synthetic_datasets', 'CATE_testing', 'tarnet_evaluation')
